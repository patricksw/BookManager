...
- Create Angular project with ng: `ng new basis.desafio.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`basis.desafio.client.esproj`).
